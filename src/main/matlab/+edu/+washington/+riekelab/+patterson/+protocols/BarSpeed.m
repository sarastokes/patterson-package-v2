classdef BarSpeed < edu.washington.riekelab.protocols.RiekeLabProtocol
    ...
    properties 
        ...
        direction = 0                   % Bar angle (degrees)
        speeds = [250, 500, 1000, 1500] % Bar speed (microns/sec)
        ...
        randomize = false               % Randomize speeds?
    ...
    methods
        ...
        function prepareRun(obj)
            ...
            % Input checking
            if rem(obj.numberOfAverages, numel(obj.speeds)) ~= 0
                error('numberOfAverages is not a factor of speeds');
            end
            ...
            obj.allSpeeds = repmat(obj.speeds,...
                [1, obj.numberOfAverages / numel(obj.allSpeeds)]);
            if obj.randomize
                obj.allSpeeds = obj.allSpeeds(randperm(obj.numberOfAverages));
            end
            ...
            rgb = edu.washington.riekelab.patterson.utils.multigradient(...
                'preset', 'div.cb.spectral.9', 'length', numel(obj.speeds));
            ...
            obj.showFigure('edu.washington.riekelab.patterson.figures.MeanResponseFigure',...
                obj.rig.getDevice(obj.amp), 'groupBy', {'speed'},...
        ...
        function prepareEpoch(obj, epoch)
            ...
            obj.speed = obj.allSpeeds(obj.numEpochsCompleted + 1);
